...
import Modulecontentbuy from "./modulecontentbuy"; // Import the dynamic ModuleContent component
import Coursematerial from "./coursematerial"; // Import the new CourseMaterial component
import { useLocation } from "react-router-dom";

const Coursemodulebuy = ({pagetitle}) => {
  const location = useLocation();
  const { id, title, instructor, description, image } = location.state || {};
  // Dynamic Data
...
export default Coursemodulebuy;
