...
const Coursecard = ({ id, title, instructor, description, image }) => {
  ...
  return (
    <div className="bg-green-500 flex flex-col md:flex-row items-center md:items-start p-4 rounded-2xl shadow-lg gap-4 mb-6">
      {/* Image Section */}
      {/* Content Section */}
      <div className="flex-1 flex flex-col md:flex-row gap-4 items-start">
        ...
        <div className="flex flex-col gap-2 w-full md:w-auto">
          ...
          className="bg-[#011E3A] text-white py-2 px-4 rounded hover:bg-slate-900 " >
            Voir Affiliation
          </button>
        </div>
      </div>
